...
docker run -i -d -p 30003:80 ctfhub:php1
...
docker run -i -d -p 30014:80 ctfhub:code2
docker run -i -d -p 30015:80 ctfhub:code21
docker run -i -d -p 30016:80 ctfhub:code12